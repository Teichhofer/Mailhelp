...
- Der interaktive Lernmodus lädt vor dem Abruf die vollständige IMAP-Ordnerliste, ergänzt neue auswählbare Ordner atomar in `config.yaml` und berücksichtigt sie sofort. Ordner mit `\\Noselect` werden nicht übernommen. Er meldet nicht lesbare Ordner, überspringt sie und verarbeitet die übrigen lesbaren Ordner weiter. Andere IMAP-Fehler werden nicht als fehlender Ordner behandelt.
