...
class Secrets(BaseModel):
    ...
    todoist_refresh_token: SecretStr
...
def load_all(directory: Path, environ: dict[str, str] | None = None) -> tuple[Settings, Secrets, list[Topic], PromptConfig, str]:
    ...
    names = ["IMAP_USERNAME", "IMAP_PASSWORD", "OPENROUTER_API_KEY", "TELEGRAM_BOT_TOKEN",
             "TODOIST_CLIENT_ID", "TODOIST_CLIENT_SECRET", "TODOIST_REFRESH_TOKEN",
