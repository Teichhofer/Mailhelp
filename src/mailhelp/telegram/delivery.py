...
from ._core import TelegramTransport
...
class ProposalDeliveryService:
    ...
    def __init__(self, repository: ProposalRepository,
                 presenter: ProposalPresenter, telegram: TelegramTransport,
                 chat_id: int):
    ...
    def deliver(self, proposal: Proposal) -> None:
        ...
        if status == "pending" and not self.repository.mark_notification_sending(proposal):
            return
